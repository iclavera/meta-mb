...
#from meta_mb.dynamics.mlp_dyanmics_ensemble_vae import MLPDynamicsEnsembleVAE
...
def run_experiment(**kwargs):
    ...
    with sess.as_default() as sess:
        ...
        env = normalize(kwargs['env'](max_torques=kwargs['max_torques'],
                                      ...
                                      ctrl_penalty=kwargs['torque_penalty'],
                                      exp_type=kwargs['exp_type'],
                                      joint=kwargs['joint'])) # Wrappers?

        model = VAE(latent_dim=kwargs['latent_dim'],
                    img_size=kwargs['img_size'],
                    lr=kwargs['vae_lr'],
                    decoder_bernoulli=['bnl_decoder'])
...
if __name__ == '__main__':
    ...
    sweep_params = {
        ...
        # Problem Conf
        'n_itr': [100], #previously 101


        'max_path_length': [200], #previously 200
        'discount': [0.99],
        'gae_lambda': [1],
        'normalize_adv': [True],
        'positive_adv': [False],
