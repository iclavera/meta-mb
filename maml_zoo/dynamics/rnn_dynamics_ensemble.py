...
from maml_zoo.dynamics.layers import RNN

import tensorflow as tf
import numpy as np
from maml_zoo.utils.serializable import Serializable
from maml_zoo.utils import compile_function
from maml_zoo.logger import logger
from maml_zoo.dynamics.rnn_dynamics import RNNDynamicsModel
import time
    ...
    def __init__(self,
        ...
        with tf.variable_scope(name, reuse=True):
            ...
            for i in range(num_models):
                ...
                self.train_op_model_batches.append(optimizer(self.step_size).apply_gradients(applied_gradients))
