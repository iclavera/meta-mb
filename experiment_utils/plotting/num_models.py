...
COLORS = dict()
LEGEND_ORDER = {'1': 0, '2': 1, '5': 2, '10': 3}

data_path = '/home/yunzhi/mb/meta-mb/final_data/num_models'
...
def plot_from_exps(exp_data,
    ...
    fig, axarr = plt.subplots(num_rows, num_columns, figsize=(20, 16))
