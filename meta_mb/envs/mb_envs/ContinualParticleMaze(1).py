...
class ContinualParticleMaze():
    ...
    def reset_grid(self, grid_name):
        ...
        self.grid_chars = (np.array(list(self.grid)) != 'S').reshape([self.grid_size,self.grid_size])
        ...
        self.grid_chars = (np.array(list(self.grid)) != 'G').reshape([self.grid_size,self.grid_size])
        ...
        self.grid = (np.array(list(self.grid)) != ' ').reshape([self.grid_size,self.grid_size])
