...
class WorkerModel(Worker):
    ...
    def prepare_start(self):
        ...
        assert self.dynamics_model.normalization is not None
        self.step()
    ...
    def push(self):
        ...
        #  5 is arbitrary.
        # TODO: push_frequency could be adjusted according tu self.queue_next.qsize()
        #  when qsize is large, decrease push_frequency to avoid unnecessary pushing and offloading
